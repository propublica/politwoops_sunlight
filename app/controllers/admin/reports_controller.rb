class Admin::ReportsController < Admin::AdminController
  ...
  def annual
    ...
    @following_tally = Politician.collecting.count

    # TODO: These should probably be only approved deleted tweets
    ...
    @deleting_account_pct = (@following_tally.zero? && 0) || (@deleting_account_tally * 100 / @following_tally)
